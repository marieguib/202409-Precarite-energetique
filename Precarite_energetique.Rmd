...
df_final$nb_inactifs <- df_final$nb_inactifs/df_final$p_pop
df_final$nb_actifs <- df_final$nb_actifs/df_final$p_pop

df_final$nb_licencies_sportifs <- df_final$nb_licencies_sportifs/df_final$p_pop
```
